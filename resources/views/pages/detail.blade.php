            ...
            <div class="row">
                    ...
                    <div class="card card-details">
                       ...
                       <div class="gallery">
                            <div class="xzoom-container">
                                <img src="{{Storage::url($item->galleries->first()->image)}}" class="xzoom" height="768" id="xzoom-default" xoriginal="{{Storage::url($item->galleries->first()->image)}}">
                            </div>
                            <div class="xzoom-thumbs">
                                @foreach($item->galleries as $gallery)
                                <a href="{{Storage::url($gallery->image)}}">
                                    <img src="{{Storage::url($gallery->image)}}" class="xzoom-gallery" width="128" height="100" xpreview="{{Storage::url($gallery->image)}}">
                                </a>
                                @endforeach
                            </div>
                        </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="join-container">
                       ...
                       @endauth
                       @guest
                       <a href="{{route('login')}}" class="btn btn-block btn-join-now mt-3 py-2">Login or Register or Join</a>
                       @endguest
                    </div>
                </div>
            </div>
